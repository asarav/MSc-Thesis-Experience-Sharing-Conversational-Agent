...
chatbot = ChatBot("Diabetes Questions",
        logic_adapters=[
            {
...
for item in range(len(conversations)):
    conversation = conversations[item]
    questDoc = nlp(conversation[0])
    answerDoc = nlp(conversation[1])
...
print(maxQuestion)
print(conversations[maxQuestionIndex])
print(maxAnswer)
print(conversations[maxAnswerIndex])

#print(maxQC)
#print(conversations[maxQCIndex])
#print(maxAC)
#print(conversations[maxACIndex])