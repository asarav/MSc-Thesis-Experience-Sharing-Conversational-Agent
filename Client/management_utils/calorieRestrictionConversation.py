conversation = [
    ...
    ["How can I cut or reduce calories? What type of strategy should I use?",
    ...
    ["How can I determine caloric intake? How can I record my calories? How can I measure my calories?",
